    ...
    for(int i=0;i<t;i++)
    {
        ...
        for(int j=1;j<n;j++)
        {
            ...
            if(YcurrentMax==islands[j][1])
            {
                ...
                else if(islands[currentTopRight-1][0]<islands[j][0])
                {
                    currentTopRight=j+1;
                }
            }
            if(YcurrentMin==islands[j][1])
            {
                ...
                else if(islands[currentBottomLeft-1][0]>islands[j][0])
                {
        ...
        //cout<<currentBottomIsland<<currentLeftMost<<currentRightMost<<currentTopIsland;

      if(islands[currentBottomIsland-1][0]>islands[currentTopIsland-1][0])
        {
